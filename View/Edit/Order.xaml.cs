namespace CourseWork_DB_ONU.View.Edit
{
    ...
    public partial class Order : Window
    {
        ...
        public Order(OrderViewModel orderViewModel, IOrderService orderService,
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _dpDate.SelectedDate = _orderViewModel.Date.ToDateTime(TimeOnly.MinValue);
                    _cbOutlet.SelectedValue = _outletService.GetOutletIdByName(_orderViewModel.OutletName);
                    _cbSupplier.SelectedValue = _supplierService.GetSupplierIdByName(_orderViewModel.SupplierName);
                    _cbProduct.SelectedValue = _productService.GetProductIdByName(_orderViewModel.ProductName);
                    _txtAmount.Text = _orderViewModel.Amount.ToString();
                    _txtPrice.Text = _orderViewModel.Price.ToString();
                }
            }
            catch (Exception ex)
            {
